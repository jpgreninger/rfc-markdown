...
RFC 9710
Simple Fixes to the IP Flow Information Export
...
, the WG realized that some parts of the IANA "IP Flow

 were not up to date. This document
...
As discussed with IANA during the development of
in
having:

[IANA-IPFIX]

 should contain a link to an existing registry, when applicable, as opposed to

[RFC9487]

, the "Additional Information" entry
...
Therefore, this document lists a set of simple fixes to the IPFIX registry
...
,
 ...
 is the normative reference for the IPFIX IEs

[RFC5102]

. Therefore, the updates in this document do not update any part

Likewise, this document is not marked as formally updating
[RFC6235] [RFC6759] [RFC7014] [RFC7015] [RFC7133] [RFC7270] [RFC8038]
...
IE-DOCTORS
IETF stream, the following from

). However, and given that many of the impacted IEs were created via the
...
This process should not in any way be construed as allowing the IE-DOCTORS to
...
[RFC768]
 ...
 for the definition of the UDP source port field.

See

[RFC9293]

 for the definition of the TCP source port field.
...
identifiers.
 ...
 also be used for future transport protocols that have 16-bit source port
...
[RFC9260]
 ...
 for the definition of the SCTP source port number field.

See

[RFC4340]

 for the definition of the DCCP source port field.
...
[RFC768]
 ...
 for the definition of the UDP destination port field.

See

[RFC9293]

 for the definition of the TCP destination port field.

See

[RFC9260]

 for the definition of the SCTP destination port number field.

See

[RFC4340]

 for the definition of the DCCP destination port field.
...
The current forwardingStatus entry in
[RFC7270]
...
. In particular, the registered Abstract Data Type is unsigned8, while it must be
 ...
 deviates from what is provided in
...
"Forwarding Status (Value 89)" registry [
...
port identifiers.
 ...
 also be used for future transport protocols that have 16-bit source
...
[IANA-IPFIX]
 ...
 registry. (In Table 1, "ID" refers to "ElementID".)
...
See the "ICMP Type Numbers" registry [
...
https://
See the "IGMP Type Numbers" registry [
www.iana.org/assignments/igmp-type-numbers
]
...
See the "ICMPv6 'type' Numbers" and "ICMPv6 'Code'
...
See the "ICMPv6 'type' Numbers" registry [
www.iana.org/assignments/icmpv6-parameters
]

https://

See the "ICMPv6 'Code' Fields" registry [
https://
www.iana.org/assignments/icmpv6-parameters
]
...
IANA has updated the "IP Flow Information Export (IPFIX) Entities" registry
...
and Destination. This Information Element
 be present in a Flow Data Record, or applied
MAY
...
within an Observation Domain or from an Exporting Process, the Option
...
[RFC1631]
 ...
 for the definition of NAT44.

See

[RFC6144]

 for the definition of NAT64.

See

[RFC6146]

 for the definition of NAT46.

See

[RFC6296]

 for the definition of NAT66.

See

[RFC791]

 for the definition of IPv4.

See

[RFC8200]

 for the definition of IPv6.
...
[RFC3022]
 ...
 for the definition of NAT (commonly named NAT44).
...
and all their parameters. The methods listed below are defined in
...
Note that the "informationElementDataType" registry has been renamed as the "IPFIX
...
[informationElementDataType] subregistry. These types are registered in the IANA IPFIX
...
as such requires a Standards Action
...
; see that section for more information on the types described in the "IPFIX

The "IPFIX Information Element Data Types" registry is intended to assign numbers for type
...
Note that the "informationElementsUnits" registry has been renamed as the "IPFIX Information
Element Units" registry.
...
the units implicitly defined in the Information Element definitions in Section 5 of the IPFIX
Information Model
the "IPFIX Information Element Units" registry. These types can take the values in the "IPFIX
Information Element Units" registry. The special value 0x00 (none) is used to note that the
field is unitless.
...
Additional information on defined TCP port numbers can be found at https://www.iana.org/
...
Most of these techniques have parameters. Its configuration parameter(s)
 be clearly
...
[RFC6313]
with the OID using IPFIX Structured Data
...
. Similarly, if different MIB capture times
...
[RFC791]
 ...
 for the definition of the IPv4 source address field.
...
IANA has updated the descriptions of the following entries in
...
The MD5 checksum of the IPFIX Message containing this record. This Information
 be bound to its containing IPFIX Message via an options record and the
...
calculate the MD5 checksum of the resulting buffer as defined in
...
Description:
Element
 appear only once in a given IPFIX Message.
messageScope Information Element, and
SHOULD
...
of the resulting buffer as defined in
...
[RFC3629]
 ...
 encoded Unicode string containing a human-readable

 be annotated with one or more language tags
...
absence of any language tag, the "i-default"
 ...
 have equivalent meaning. In the
...
[RFC5610]
 ...
 for notes on string handling for
...
Sections 4 to 7 include actions for IANA. These actions are not repeated here. IANA has added a
reference to this document for each of the entries updated per this document.
...
Information Export (IPFIX) Entities" registry group
...
The initial values for this registry were provided in
[RFC5102]
...
Trammell, B.
Information Export (IPFIX) Information Elements" BCP 184 RFC 7013 DOI
10.17487/RFC7013

B. Claise "Guidelines for Authors and Reviewers of IP Flow
...
P. Francis "The IP Network Address Translator (NAT)" RFC
...
G. Adams "Language Tagging in Unicode Plain Text" RFC 2482
,
...
S. Brim "Middleboxes: Taxonomy and Issues" RFC 3234 DOI
,
, February 2002,
...
M. Davis "Tags for Identifying Languages" RFC 4646 DOI
...
Trammell, B.
Information Export (IPFIX)" RFC 5103 DOI 10.17487/RFC5103
<https://www.rfc-editor.org/info/rfc5103>

E. Boschi "Bidirectional Flow Export Using IP Flow
...
Boschi, E. Trammell, B. Mark, L.
IP Flow Information Export (IPFIX) Information Elements" RFC 5610 DOI
10.17487/RFC5610

,
<https://www.rfc-editor.org/info/rfc5610>

T. Zseby "Exporting Type Information for
,
...
Trammell, B. Boschi, E. Mark, L. Zseby, T.
IP Flow Information Export (IPFIX) File Format" RFC 5655 DOI 10.17487/
RFC5655

A. Wagner "Specification of the
,

<https://www.rfc-editor.org/info/rfc5655>
...
, and
,
6144 DOI 10.17487/RFC6144
,
rfc6144>

.

K. Yin "Framework for IPv4/IPv6 Translation" RFC
,
, April 2011,
...
B. Trammell "IP Flow Anonymization Support" RFC 6235 DOI
...
F. Baker "IPv6-to-IPv6 Network Prefix Translation" RFC
...
N. Ben-Dvora "Cisco Systems Export of Application
Claise, B. Aitken, P.
,
,
Information in IP Flow Information Export (IPFIX)" RFC 6759 DOI 10.17487/
RFC6759

<https://www.rfc-editor.org/info/rfc6759>
...
Trammell, B. Wagner, A.
,
Information Export (IPFIX) Protocol" RFC 7015 DOI 10.17487/RFC7015
September 2013,

,
<https://www.rfc-editor.org/info/rfc7015>

B. Claise "Flow Aggregation for the IP Flow
...
Kashima, S. Kobayashi, A., Ed.
, and
Link Layer Traffic Measurement" RFC 7133 DOI 10.17487/RFC7133
,
...
P. Aitken "Information Elements for Data
...
Aitken, P., Ed. Claise, B. S, S. B. McDowall, C.
J. Schoenwaelder "Exporting
MIB Variables Using the IP Flow Information Export (IPFIX) Protocol" RFC 8038
...
Sivakumar, S.
Elements for Logging NAT Events" RFC 8158 DOI 10.17487/RFC8158
,
2017,

<https://www.rfc-editor.org/info/rfc8158>

R. Penno "IP Flow Information Export (IPFIX) Information
...
Boucadair, M. "An Update to the tcpControlBits IP Flow Information Export
(IPFIX) Information Element" RFC 9565 DOI 10.17487/RFC9565
,
...
Many thanks to
specification. Special thanks to
collected.

 for the review and many suggestions that enhanced this

Andrew Feren

 for sharing data about scans of IPFIX data he

Thomas Graf
Shepherd review.

 tagged an issue with the forwardingStatus Information Element and for the
