\title{
$3{ }^{\text {rd }}$ Generation Partnership Project; \\ Technical Specification Group Radio Access Network; Evolved Universal Terrestrial Radio Access (E-UTRA); Packet Data Convergence Protocol (PDCP) specification (Release 14)
}
...
\footnotetext{
The present document has been developed within the $3{ }^{\text {rd }}$ Generation Partnership Project ( $3 \mathrm{GPP}{ }^{\mathrm{TM}}$ ) and may be further elaborated for the purposes of 3GPP. The present document has not been subject to any approval process by the 3GPP Organizational Partners and shall not be implemented.
...
\hline ARP & Address Resolution Protocol \\
\hline CID & Context Identifier \\
\hline DRB & Data Radio Bearer carrying user plane data \\
...
\hline FMS & First missing PDCP SN \\
\hline HFN & Hyper Frame Number \\
\hline HRW & Highest Received PDCP SN on WLAN \\
\hline IETF & Internet Engineering Task Force \\
\hline IP & Internet Protocol \\
\hline L2 & Layer 2 (data link layer) \\
\hline L3 & Layer 3 (network layer) \\
\hline LWA & LTE-WLAN Aggregation \\
\hline MAC & Medium Access Control \\
\hline MAC-I & Message Authentication Code for Integrity \\
\hline MCG & Master Cell Group \\
\hline NB-IoT & Narrow Band Internet of Things \\
\hline NMP & Number of Missing PDCP SDUs \\
\hline PDCP & Packet Data Convergence Protocol \\
\hline PDU & Protocol Data Unit \\
\hline PEK & ProSe Encryption Key \\
\hline PGK & ProSe Group Key \\
\hline ProSe & Proximity-based Services \\
\hline PTK & ProSe Traffic Key \\
\hline R & Reserved \\
\hline RB & Radio Bearer \\
\hline RFC & Request For Comments \\
\hline RLC & Radio Link Control \\
\hline RN & Relay Node \\
\hline ROHC & RObust Header Compression \\
\hline RRC & Radio Resource Control \\
\hline RTP & Real Time Protocol \\
...
\subsection*{4.2 PDCP architecture}

\subsection*{4.2.1 PDCP structure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-08.jpg?height=812&width=1543&top_left_y=1576&top_left_x=264}
\captionsetup{labelformat=empty}
\caption{Figure 4.2.1.1 - PDCP layer, structure view}
\end{figure}
...
\subsection*{4.2.2 PDCP entities}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-10.jpg?height=1290&width=1347&top_left_y=248&top_left_x=360}
\captionsetup{labelformat=empty}
\caption{Figure 4.2.2.1 - PDCP layer, functional view}
\end{figure}
...
\section*{5 PDCP procedures}

\subsection*{5.1 PDCP Data Transfer Procedures}

\subsection*{5.1.1 UL Data Transfer Procedures}
...
\subsection*{5.1.2 DL Data Transfer Procedures}

\subsection*{5.1.2.1 Procedures for DRBs}
5.1.2.1.1 Void

\subsection*{5.1.2.1.2 Procedures for DRBs mapped on RLC AM when the reordering function is not used}
...
\subsection*{5.1.2.1.2a RN procedures for DRBs mapped on RLC AM}
...
\subsection*{5.1.2.1.3 Procedures for DRBs mapped on RLC UM}
...
\subsection*{5.1.2.1.3a RN procedures for DRBs mapped on RLC UM}
...
\subsection*{5.1.2.1.4 Procedures for DRBs mapped on RLC AM and for LWA bearers when the reordering function is used}
...
\subsection*{5.1.2.1.4.1 Procedures when a PDCP PDU is received from the lower layers}
...
\subsection*{5.1.2.1.4.2 Procedures when $t$-Reordering expires}
...
\subsection*{5.1.2.1.4.3 Procedures when the value of $t$-Reordering is reconfigured}
...
\subsection*{5.1.2.2 Procedures for SRBs}
...
\subsection*{5.1.3 SL Data Transmission Procedures}
...
\subsection*{5.1.4 SL Data Reception Procedures}
...
\subsection*{5.2 Re-establishment procedure}
...
\subsection*{5.2.1 UL Data Transfer Procedures}

\subsection*{5.2.1.1 Procedures for DRBs mapped on RLC AM}
...
\subsection*{5.2.1.2 Procedures for DRBs mapped on RLC UM}
...
\subsection*{5.2.1.3 Procedures for SRBs}
...
\subsection*{5.2.2 DL Data Transfer Procedures}

\subsection*{5.2.2.1 Procedures for DRBs mapped on RLC AM while the reordering function is not used}
...
\subsection*{5.2.2.1a Procedures for DRBs mapped on RLC AM while the reordering function is used}
...
\subsection*{5.2.2.2 Procedures for DRBs mapped on RLC UM}
...
\subsection*{5.2.2.3 Procedures for SRBs}
...
\subsection*{5.3 PDCP Status Report}

\subsection*{5.3.1 Transmit operation}
...
\subsection*{5.3.2 Receive operation}
...
\subsection*{5.5 Header Compression and Decompression}

\subsection*{5.5.1 Supported header compression protocols and profiles}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 5.5.1.1: Supported header compression protocols and profiles}
\begin{tabular}{|l|l|l|}
\hline Profile Identifier & Usage: & Reference \\
\hline 0x0000 & No compression & RFC 4995 \\
\hline 0x0001 & RTP/UDP/IP & RFC 3095, RFC 4815 \\
\hline 0x0002 & UDP/IP & RFC 3095, RFC 4815 \\
\hline 0x0003 & ESP/IP & RFC 3095, RFC 4815 \\
\hline 0x0004 & IP & RFC 3843, RFC 4815 \\
\hline 0x0006 & TCP/IP & RFC 4996 \\
\hline 0x0101 & RTP/UDP/IP & RFC 5225 \\
\hline 0x0102 & UDP/IP & RFC 5225 \\
\hline 0x0103 & ESP/IP & RFC 5225 \\
\hline 0x0104 & IP & RFC 5225 \\
\hline
\end{tabular}
\end{table}

\subsection*{5.5.2 Configuration of header compression}
...
\subsection*{5.5.3 Protocol parameters}
...
\subsection*{5.5.4 Header compression}
...
\subsection*{5.5.5 Header decompression}
...
\subsection*{5.5.6 PDCP Control PDU for interspersed ROHC feedback packet}

\subsection*{5.5.6.1 Transmit Operation}
...
\subsection*{5.5.6.2 Receive Operation}
...
\subsection*{5.6 Ciphering and Deciphering}
...
\subsection*{5.6.1 SL Ciphering and Deciphering for one-to-many communication}
...
\subsection*{5.6.2 SL Ciphering and Deciphering for one-to-one communication}
...
\subsection*{5.7 Integrity Protection and Verification}
...
\subsection*{5.8 Handling of unknown, unforeseen and erroneous protocol data}

When a PDCP entity receives a PDCP PDU that contains reserved or invalid values, the PDCP entity shall:
- discard the received PDU.

\subsection*{5.9 PDCP Data Recovery procedure}
...
\subsection*{5.10 Status report for LWA}

\subsection*{5.10.1 Transmit operation}
...
\subsection*{5.10.2 LWA status report}
...
\subsection*{6.1.1 PDCP Data PDU}
...
\subsection*{6.1.2 PDCP Control PDU}
...
\subsection*{6.2.2 Control plane PDCP Data PDU}

Figure 6.2.2.1 shows the format of the PDCP Data PDU carrying data for control plane SRBs.

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-27.jpg?height=595&width=814&top_left_y=285&top_left_x=623}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.2.1: PDCP Data PDU format for SRBs}
\end{figure}

\subsection*{6.2.3 User plane PDCP Data PDU with long PDCP SN (12 bits)}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-27.jpg?height=332&width=782&top_left_y=1334&top_left_x=596}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.3.1: PDCP Data PDU format for DRBs using a 12 bit SN}
\end{figure}

\subsection*{6.2.4 User plane PDCP Data PDU with short PDCP SN (7 bits)}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-27.jpg?height=252&width=780&top_left_y=2133&top_left_x=635}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.4.1: PDCP Data PDU format for DRBs using 7 bit SN}
\end{figure}

\subsection*{6.2.5 PDCP Control PDU for interspersed ROHC feedback packet}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-28.jpg?height=241&width=780&top_left_y=479&top_left_x=635}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.5.1: PDCP Control PDU format for interspersed ROHC feedback packet}
\end{figure}

\subsection*{6.2.6 PDCP Control PDU for PDCP status report}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-28.jpg?height=433&width=816&top_left_y=1329&top_left_x=621}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.6.1: PDCP Control PDU format for PDCP status report using a 12 bit SN}
\end{figure}

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-28.jpg?height=515&width=819&top_left_y=2051&top_left_x=612}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.6.2: PDCP Control PDU format for PDCP status report using a 15 bit SN}
\end{figure}

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-29.jpg?height=515&width=816&top_left_y=242&top_left_x=612}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.6.3: PDCP Control PDU format for PDCP status report using an 18 bit SN}
\end{figure}
6.2.7 Void

\subsection*{6.2.8 RN user plane PDCP Data PDU with integrity protection}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-29.jpg?height=671&width=812&top_left_y=1388&top_left_x=593}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.8.1: PDCP Data PDU format for RN DRBs using integrity protection}
\end{figure}

\subsection*{6.2.9 User plane PDCP Data PDU with extended PDCP SN (15 bits)}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-30.jpg?height=334&width=790&top_left_y=283&top_left_x=593}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.9.1: PDCP Data PDU format for DRBs using a 15 bit SN}
\end{figure}

\subsection*{6.2.10 User plane PDCP Data PDU for SLRB}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-30.jpg?height=540&width=782&top_left_y=1005&top_left_x=605}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.10.1: PDCP Data PDU format for SLRB used for one-to-many communication}
\end{figure}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-31.jpg?height=958&width=949&top_left_y=242&top_left_x=552}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.10.2: PDCP Data PDU format for SLRB used for one-to-one communication}
\end{figure}

\subsection*{6.2.11 User plane PDCP Data PDU with further extended PDCP SN (18 bits)}
...
\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-31.jpg?height=409&width=766&top_left_y=1631&top_left_x=630}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.11.1: PDCP Data PDU format for DRBs using an 18 bit SN}
\end{figure}

\subsection*{6.2.12 PDCP Control PDU for LWA status report}
...
\begin{tabular}{|l|l|l|}
\hline D/C & PDU Type & FMS \\
\hline \multicolumn{3}{|c|}{FMS (cont.)} \\
\hline \multicolumn{3}{|c|}{HRW} \\
\hline & HRW (cont.) & NMP \\
\hline \multicolumn{3}{|c|}{NMP (cont.)} \\
\hline
\end{tabular}
...
\hline \multicolumn{6}{|c|}{} & \multirow[b]{2}{*}{Oct 1} \\
\hline D/C & PDU Type & R & R & R & R & \multirow[b]{2}{*}{Oct 2} \\
\hline R & \multicolumn{5}{|c|}{FMS} & \\
\hline \multicolumn{6}{|c|}{FMS (cont.)} & Oct 3 \\
\hline R & \multicolumn{5}{|c|}{HRW} & Oct 4 \\
\hline \multicolumn{6}{|c|}{HRW (cont.)} & Oct 5 \\
\hline R & \multicolumn{5}{|c|}{NMP} & Oct 6 \\
\hline \multicolumn{6}{|c|}{NMP (cont.)} & Oct 7 \\
\hline
\end{tabular}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.12.2: PDCP Control PDU format for LWA status report using a 15 bit SN}
\end{table}

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/02c733cd-3648-40e4-a867-1b90fad16e3a-32.jpg?height=713&width=775&top_left_y=1841&top_left_x=612}
\captionsetup{labelformat=empty}
\caption{Figure 6.2.12.3: PDCP Control PDU format for LWA status report using an 18 bit SN}
\end{figure}

\subsection*{6.3 Parameters}
...
\subsection*{6.3.2 PDCP SN}

Length: 5, 7, 12, 15, 16, or 18 bits as indicated in table 6.3.2.1 except for NB-IoT which uses 7 bit PDCP SN for DRB.

\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 6.3.2.1: PDCP SN length}
\begin{tabular}{|c|l|}
\hline Length & \multicolumn{1}{|c|}{ Description } \\
\hline 5 & SRBs \\
\hline 7 & DRBs, if configured by upper layers (pdcp-SN-Size [3]) \\
\hline 12 & DRBs, if configured by upper layers (pdcp-SN-Size [3]) \\
\hline 15 & DRBs, if configured by upper layers (pdcp-SN-Size [3]) \\
\hline 16 & SLRBs \\
\hline 18 & DRBs, if configured by upper layers (pdcp-SN-Size [3]) \\
\hline
\end{tabular}
\end{table}

\subsection*{6.3.3 Data}
...
\end{tabular}
\captionsetup{labelformat=empty}
\caption{Figure 6.3.5.1: Format of COUNT}
\end{table}
...
\subsection*{6.3.7 D/C}

Length: 1 bit

\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 6.3.7.1: D/C field}
\begin{tabular}{|c|l|}
\hline Bit & \multicolumn{1}{c|}{ Description } \\
\hline 0 & Control PDU \\
\hline 1 & Data PDU \\
\hline
\end{tabular}
...
\subsection*{6.3.8 PDU type}

Length: 3 bits

\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 6.3.8.1: PDU type}
\begin{tabular}{|c|l|}
\hline Bit & \multicolumn{1}{|c|}{ Description } \\
\hline 000 & PDCP status report \\
\hline 001 & Interspersed ROHC feedback packet \\
\hline 010 & LWA status report \\
\hline $011-$ & reserved \\
111 & \\
\hline
\end{tabular}
...
retransmitted. The bit position of $\mathrm{N}^{\text {th }}$ bit in the Bitmap is \\
...
\subsection*{6.3.11 Interspersed ROHC feedback packet}
...
\subsection*{6.3.12 PGK Index}

Length: 5 bits
5 LSBs of PGK Identity as specified in [13].

\subsection*{6.3.13 PTK Identity}

Length: 16 bits
PTK Identity as specified in [13].

\subsection*{6.3.14 SDU Type}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 6.3.14.1: SDU Type}
\begin{tabular}{|c|l|}
\hline Bit & \multicolumn{1}{|c|}{ Description } \\
\hline 000 & IP \\
\hline 001 & ARP \\
\hline 010 & PC5 Signaling \\
\hline 011 & Non-IP \\
\hline $100-111$ & reserved \\
\hline
\end{tabular}
\end{table}

\subsection*{6.3.15 $\mathrm{K}_{\text {D-sess }}$ ID}

Length: 16 bits
$\mathrm{K}_{\mathrm{D} \text {-sess }}$ Identity as specified in [13].

\subsection*{6.3.16 NMP}
...
\subsection*{7.3 Constants}

\section*{a) Reordering_Window}
...
\hline \multicolumn{8}{|c|}{Change history after change control} \\
\hline Date & TSG \# & TSG Doc. & CR & Rev & Subject/Comment & Old & New \\
\hline 2007-12 & RP-38 & RP-070919 & - & - & Approved at TSG-RAN \#38 and placed under Change Control & 2.0.0 & 8.0.0 \\
\hline 2008-03 & RP-39 & RP-080197 & 0001 & - & CR to 36.323 with Update of E-UTRAN PDCP specification & 8.0.0 & 8.1.0 \\
\hline 2008-05 & RP-40 & RP-080412 & 0002 & - & Clarification of the BSR calculation & 8.1.0 & 8.2.0 \\
\hline & RP-40 & RP-080412 & 0003 & 1 & PDCP minor changes & 8.1.0 & 8.2.0 \\
\hline & RP-40 & RP-080387 & 0004 & 3 & Addition of a duplicate discard window & 8.1.0 & 8.2.0 \\
\hline & RP-40 & RP-080412 & 0006 & - & Reference to ROHCv2 profiles & 8.1.0 & 8.2.0 \\
\hline & RP-40 & RP-080412 & 0010 & - & Bitmap in the DL PDCP status report & 8.1.0 & 8.2.0 \\
\hline & - & - & - & - & Corrections to sections 5.5.1.1, 5.5.1.2.1 and 5.8 to correctly implement CR0004 Rev 3 (instead of CR0004 Rev 2 of RP080412). & 8.2.0 & 8.2.1 \\
\hline 2008-09 & RP-41 & RP-080692 & 0013 & - & Restructuring of PDCP specification & 8.2.1 & 8.3.0 \\
\hline & RP-41 & RP-080692 & 0016 & - & Miscellaneous PDCP corrections & 8.2.1 & 8.3.0 \\
\hline & RP-41 & RP-080692 & 0023 & - & Correction to the PDCP structure & 8.2.1 & 8.3.0 \\
\hline & RP-41 & RP-080692 & 0033 & - & Initial TX_HFN and RX_HFN values & 8.2.1 & 8.3.0 \\
\hline 2008-12 & RP-42 & RP-081020 & 0038 & - & Clarification with regards to the PDCP state variables & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0039 & - & CR 0039 to 36.323 on Correction to PDCP functional view & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0040 & - & PDCP "in-sequence delivery and duplicate elimination" always on & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0041 & - & Proposed CR to 36.323 on Processing of PDCP SDU received from upper layer & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0042 & - & Error in AM receive window behaviour & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0047 & - & Proposed CR on the described scope of Last_Submitted_PDCP_RX_SN & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0048 & - & Proposed CR to move DIRECTION from parameters provided by upper layer & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0049 & - & Clarification on COUNT & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0050 & - & Correction to PDCP procedure for SRB & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0052 & - & Correction to the PDCP re-establishment procedure & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0054 & - & Correction to PDCP functional view & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0055 & - & Miscellaneous PDCP corrections & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0057 & - & Proposed CR for error handling & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0060 & - & Proposed CR to 36.323 on Correction to PDCP Control PDU description & 8.3.0 & 8.4.0 \\
\hline & RP-42 & RP-081020 & 0061 & 1 & Corrections to PDCP STATUS REPORT & 8.3.0 & 8.4.0 \\
\hline 2009-03 & RP-43 & RP-090130 & 0064 & - & CR to specify maximum PDCP SDU size & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0065 & - & CR with correction on PDCP function of maintaining SNs & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0066 & - & Miscellaneous corrections to 36.323 & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0067 & - & Minor issues on PDCP & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0068 & - & Security related corrections & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0069 & - & CR to 36.323 on RRC Parameters & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0070 & 1 & Corrections on BSR reporting and transmission/ retransmission after an Handover & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0071 & - & Corrections on PDCP services and functions & 8.4.0 & 8.5.0 \\
\hline & RP-43 & RP-090130 & 0077 & - & PDCP Control PDU as Data Available for transmission in PDCP & 8.4.0 & 8.5.0 \\
\hline 2009-06 & RP-44 & RP-090515 & 0078 & 1 & PDCP Status Report & 8.5.0 & 8.6.0 \\
\hline & RP-44 & RP-090515 & 0079 & 1 & Correction to PDCP PDU submission condition in lower layer reestablishment & 8.5.0 & 8.6.0 \\
\hline & RP-44 & RP-090515 & 0080 & 2 & Minor correction and clarification to 36.323 & 8.5.0 & 8.6.0 \\
\hline 2009-12 & RP-46 & - & - & & Upgrade to the Release 9 - no technical change & 8.6.0 & 9.0.0 \\
\hline 2010-12 & RP-50 & - & - & & Upgrade to the Release 10 - no technical change & 9.0.0 & 10.0.0 \\
\hline 2011-03 & RP-51 & RP-110280 & 0086 & - & Clarification on the number of ROHC instances in a PDCP entity & 10.0.0 & 10.1.0 \\
\hline & RP-51 & RP-110291 & 0087 & - & Addition of integrity protection of DRBs in PDCP for RNs & 10.0.0 & 10.1.0 \\
\hline 2012-03 & RP-57 & RP-121377 & 0099 & 1 & Introduction of Carrier aggregation enhancements & 10.1.0 & 11.0.0 \\
\hline 2012-12 & RP-58 & RP-121959 & 0100 & - & CR to 36.323 on introducing ROHC context continue for intra-ENB handover & 11.0.0 & 11.1.0 \\
\hline & RP-58 & RP-121959 & 0104 & 1 & ROHC mode upon handover & 11.0.0 & 11.1.0 \\
\hline & RP-58 & RP-121936 & 0106 & - & Prevention of HFN de-synchronization due to PDCP SN overallocation & 11.0.0 & 11.1.0 \\
\hline 2013-03 & RP-59 & RP-130248 & 0109 & - & ROHC mode upon handover in UM DRB & 11.1.0 & 11.2.0 \\
\hline 2014-06 & RP-64 & RP-140869 & 0113 & - & Clarification of CID reuse & 11.2.0 & 11.3.0 \\
\hline & RP-64 & RP-140892 & 0123 & - & ROHC Feedback Handling & 11.3.0 & 12.0.0 \\
\hline 2014-09 & RP-65 & RP-141498 & 0126 & - & Clarification of the decompressor state and mode after PDCP reestablishment & 12.0.0 & 12.1.0 \\
\hline 2014-12 & RP-66 & RP-142135 & 0128 & 1 & Introduction of dual connectivity in PDCP & 12.1.0 & 12.2.0 \\
\hline 2015-03 & RP-67 & RP-150373 & 0133 & - & Reconfiguration of PDCP reordering timer & 12.2.0 & 12.3.0 \\
\hline & RP-67 & RP-150374 & 0135 & - & Introduction of ProSe Direct Communication & 12.2.0 & 12.3.0 \\
\hline
\end{tabular}

\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline 2015-06 & RP-68 & RP-150921 & 0137 & - & COUNT derivation in ProSe & 12.3.0 & 12.4.0 \\
\hline & RP-68 & RP-150921 & 0138 & - & Miscellaneous corrections for DC & 12.3.0 & 12.4.0 \\
\hline & RP-68 & RP-150921 & 0139 & - & BSR Triggering for Split Bearers & 12.3.0 & 12.4.0 \\
\hline 2015-12 & RP-70 & RP-152053 & 0145 & - & Corrections to Sidelink & 12.4.0 & 12.5.0 \\
\hline & RP-70 & RP-152053 & 0144 & 1 & Update to Services expected from Lower Layers in DC & 12.4.0 & 12.5.0 \\
\hline 2015-12 & RP-70 & RP-152074 & 0146 & - & Introduction of UL split bearer in PDCP & 12.5.0 & 13.0.0 \\
\hline & RP-70 & RP-152071 & 0148 & 1 & Introduction of enhanced CA in PDCP & 12.5.0 & 13.0.0 \\
\hline & RP-70 & RP-152072 & 0149 & 2 & Introducing enhanced ProSe & 12.5.0 & 13.0.0 \\
\hline 2016-03 & RP-71 & RP-160454 & 0155 & - & Correction for KD-sess Identity in 36.323 & 13.0.0 & 13.1.0 \\
\hline & RP-71 & RP-160457 & 0158 & 4 & Introduction of LWA into PDCP specification & 13.0.0 & 13.1.0 \\
\hline 2016-06 & RP-72 & RP-161080 & 0160 & - & Clarification on LWA & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161078 & 0162 & 1 & Data available for transmission due to PDCP data recovery & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161080 & 0163 & - & Correction for sidelink & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161078 & 0165 & - & Corrections on RoHC description & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161080 & 0166 & 1 & Clarification on Control PDU for LWA & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161080 & 0169 & - & Polling for LWA status report & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161091 & 0171 & 4 & Introduction of NB-IoT functionality to PDCP protocol & 13.1.0 & 13.2.0 \\
\hline & RP-72 & RP-161080 & 0172 & - & PDCP CR to capture C-IoT optimizations for non-NB-IoT UEs & 13.1.0 & 13.2.0 \\
\hline 2016-06 & RP-72 & RP-161080 & 0160 & - & Missing changes from CR0160 (Clarification on LWA) added & 13.2.0 & 13.2.1 \\
\hline 2016-09 & RP-73 & RP-161756 & 0175 & 1 & Addition of COUNT determination for the purpose of HRW setting & 13.2.1 & 13.3.0 \\
\hline & RP-73 & RP-161756 & 0177 & 1 & Clarification on NMP in LWA status report & 13.2.1 & 13.3.0 \\
\hline & RP-73 & RP-161756 & 0179 & - & Corrections to PDCP Status Reporting & 13.2.1 & 13.3.0 \\
\hline 2016-09 & RP-73 & - & - & - & MCC cleanup and missing text from v13.2.1 added & 13.3.0 & 13.3.1 \\
\hline 2016-09 & RP-73 & RP-161746 & 0174 & 2 & Introduction of PC5 V2V for 36.323 & 13.3.1 & 14.0.0 \\
\hline 2016-09 & RP-73 & - & - & - & MCC cleanup & 14.0.0 & 14.0.1 \\
\hline 2016-12 & RP-74 & RP-162318 & 0182 & - & Correction of security handling upon connection suspension & 14.0.1 & 14.1.0 \\
\hline & RP-74 & RP-162317 & 0185 & 1 & Corrections to handling of uplink split & 14.0.1 & 14.1.0 \\
\hline
\end{tabular}