...
RFC 9486
IPv6 Options for In Situ Operations, Administration,
...
The IOAM E2E Option, defined in
...
require alignment on multiples of 4 bytes. This ensures that fields specified in
...
IOAM deployments in IPv6 networks
into account.

MUST

 take the following considerations and requirements
...
IOAM
 be deployed in an IOAM-Domain. An IOAM-Domain is a set of nodes that use
...
managed by the same administrative entity. Please refer to
IOAM-Domains.
...
MUST
 ...
 ensure that the addition of IOAM Data-Fields does not

Implementations of IOAM
...
added "on-demand". Implementations of IOAM
...
but desire to encapsulate/decapsulate IOAM on transit nodes
...
. Security considerations of the specific IOAM Data-Fields
...
IOAM information
 ...
 be leaked through the boundaries of the IOAM-Domain.
...
according to the constraints specified in
defined in
processing are not defined in this document. Future documents may define the use of IOAM with
AH and its processing.

 to secure IOAM options. The use of IOAM options with AH and its

. IOAM-Domain does not rely on the AH as
...
IANA has assigned the IPv6 Option-Types from the "Destination Options and Hop-by-Hop
Options" subregistry of "Internet Protocol Version 6 (IPv6) Parameters"
...
IOAM Destination Option and IOAM Hop-by-
Hop Option
...
Elkins, N. Hamilton, R.
Metrics (PDM) Destination Option" RFC 8250 DOI 10.17487/RFC8250
,
2017,

<https://www.rfc-editor.org/info/rfc8250>

M. Ackermann "IPv6 Performance and Diagnostic
...
Tom Herbert Éric Vyncke Nalini Elkins Srihari Raghavan

The authors would like to thank
Ranganathan T S Karthik Babu Harichandra Babu Akshaya Nadahalli Stefano Previdi Hemant
Singh Erik Nordmark LJ Wobker Mark Smith Andrew Yourtchenko
 for the
,
,
comments and advice. For the IPv6 encapsulation, this document leverages concepts described in
[IPV6-RECORD-ROUTE]
Hiroshi Kitamura
...
This document was the collective effort of several authors. The text and content were contributed
